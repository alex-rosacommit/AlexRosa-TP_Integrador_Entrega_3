...
public class ConeccionDataBase {
	/* Parametros para coneccion con base de datos local.
	 *
	 *para utilizar la conoceccion local solo basta con quitar el comentario
	...
	*/
	...
	private Connection miConeccion = null;
	
	public ConeccionDataBase(){
		System.out.println("Creando coneccion con la base de datos. Por favor aguarde un momento.");
	}
	...
	public void testConection() {
		...
		try {
			...
			miConeccion = DriverManager.getConnection("jdbc:mysql://"+ dbUser +":"+ dbPass +"@"+ dbHost +":"+ dbPort +"/" + dbName);
	        ...
	        Statement stmt = miConeccion.createStatement();
